<cfcomponent displayname="ppm_context" hint="PPM Context class">
    ...
    <cffunction name="Open" access="public" returntype="workFlow.PPM.ppm_context">
    	<cfargument name="Context" type="string" required="yes" hint="The PPM context">
        ...
        <cfquery name="ctx" datasource="webwarecl">
        	SELECT * FROM ppm_contexts WHERE ctx_name='#this.Context#'
		</cfquery>
    ...
    <cffunction name="WriteLogEntry" access="private" returntype="void" hint="Write a log entry">
        ...
        <cfquery name="WLE" datasource="webwarecl">
    ...
    <cffunction name="GetLogEntries" access="public" returntype="query" hint="Get log entries for this context">
        ...
        <cfquery name="gle" datasource="webwarecl">
