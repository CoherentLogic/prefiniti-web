...
<cfoutput><title>Project #URL.clsJobNUmber# - Invoice</title></cfoutput>
<style type="text/css">
	body {
...
<cfwindow name="InvoiceSettings" title="Invoice #URL.clsJobNumber#" width="500" height="450" initshow="true" draggable="false" resizable="false" modal="true" center="true" closable="false" bodystyle="background-color:##EFEFEF">
	...
	<cfform name="InvoiceSettings" format="xml" skin="basiccss" width="400" preservedata="Yes" action="/workFlow/components/invoiceProjectGen.cfm" method="post">
